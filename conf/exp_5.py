...
from models.resunet.networks import ResUnetJFNoSkip

def get_model(log):
    log.info('Model JF Resunet no skip')
    ...
    model = ResUnetJFNoSkip(input_depth_0, input_depth_1, model_depths, general.N_CLASSES)
